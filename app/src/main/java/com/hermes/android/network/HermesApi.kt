...
interface HermesApi {
    ...
    @GET("api/workspaces")
    suspend fun listWorkspaces(): Response<WorkspaceListResponse>
    
    @GET("api/workspaces/suggest")
    suspend fun suggestWorkspaces(
        @Query("prefix") prefix: String
    ): Response<WorkspaceSuggestionResponse>
    ...
    suspend fun listProjects(
        @Query("all_profiles") allProfiles: Boolean? = null
    ): Response<Map<String, Any>>
}
